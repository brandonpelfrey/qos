...
static const size_t KERNEL_STACK_TOP = KERNEL_STACK_BASE + KERNEL_STACK_SIZE - 16;

static const size_t KERNEL_DYNAMIC = KERNEL_BASE + KERNEL_CODE_SIZE + KERNEL_STACK_SIZE;